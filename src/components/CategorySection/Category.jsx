...
const iconMap = {
  ...
  spain: <GiSpain className="text-3xl text-red-600" />,
  france: <GiFrance className="text-3xl text-blue-600" />,
...
const Category = ({ icon = "teacher", name, tutors }) => {
  return (
    <Link to={`/find-tutors/${name}`} className="flex cursor-pointeritems-center justify-between gap-4 p-4 shadow-md rounded-xl hover:shadow-lg transition">
